    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        {cropCalendarData.map((season) => (
          <div key={season.season} className="bg-white rounded-lg shadow-md p-6">
            <div className="mb-4">
              <h2 className="text-2xl font-semibold text-gray-900">{season.season} Season</h2>
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="bg-gray-50">
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sowing Time</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {season.crops.map((crop) => (
                    <tr key={crop.name} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{crop.sowingTime}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{crop.harvestTime}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
